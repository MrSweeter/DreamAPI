...
public class SidebarDisplayer {
	...
	public SidebarDisplayer(String name)	{
		...
		if (scoreboard.getObjective("msd-dream-040617") != null)	{scoreboard.getObjective("msd-dream-040617").unregister();}
	 ...
	 * @param lines the number of the row
	 * @return the display, can be null or empty
	 */
	...
	/**
	 * Show the sidebar scoreboard to player
